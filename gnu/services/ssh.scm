...
(define-record-type* <openssh-client-host-configuration>
  (host openssh-client-host-configuration-host ;string
        (default "") "")
  (host-name openssh-client-host-configuration-host-name ;string
             (default "") "")
  (port openssh-client-host-configuration-port ;string
        (default 22) "")
  (user openssh-client-host-configuration-user ;string
        (default "") "")
  (identity-file openssh-client-host-configuration-identity-file ;string
                 (default "") "")
  (user-known-hosts-file
   openssh-client-host-configuration-user-known-hosts-file ;string
   (default "") "")
  (strict-host-key-checking?
   openssh-client-host-configuration-strict-host-key-checking? ;string
   (default #t) "")
  (extra-options openssh-client-host-configuration-extra-options ;string
                 (default "")
                 ""))

(define-record-type* <openssh-client-configuration>
  (hosts openssh-client-configuration-hosts ;list
         (default '())))
...
(define openssh-client-host-configuration
  ;; Return the SSH client configuration file corresponding to CONFIG.
  (match-lambda
    (($ <openssh-client-host-configuration> 
        host host-name port user identity-file user-known-hosts-file
        strict-host-key-checking? extra-options)
     (mixed-text-file
      "ssh-client.conf"
      "Host" host
      "Port"
