      ...
      (arguments
       '(#:modules ((guix build utils))
         ...
         (begin
           ...
           (chdir "util/stumpish")
           (substitute* "stumpish"
             (("rlwrap") (string-append (assoc-ref %build-inputs "rlwrap") "/bin/rlwrap"))
             (("/bin/sh") (string-append (assoc-ref %build-inputs "bash") "/bin/bash")))
...
(define-public sbcl-stumpwm-swm-gaps
  (let ((commit "dd5b037923ec7d3cc27c55806bcec5a1b8cf4e91")
    ...
    (package
      ...
      (description "This package provides a StumpWM module add gaps between
windows.")
      (license (list license:gpl2+ license:gpl3+ license:bsd-2)))))
