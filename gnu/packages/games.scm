...
(define-public cataclysm-dda
  ;; Use a newer version than a release, because of tiles support.
  (let ((commit "d0f778b3e28b1ca3a007ed6f47640a1197c6b4e2"))
    (package
      (name "cataclysm-dda")
      (version (git-version "0.C" "1" commit))
      (source (origin
                (method git-fetch)
                (uri (git-reference
                ...
                (sha256
                 (base32
                  "09cdmbnx93caa0d4zdc2g5cf6mjcf26qb8vlh9njkn1gxx12nxq9"))
